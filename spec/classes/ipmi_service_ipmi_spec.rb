...
describe 'ipmi::service::ipmi', type: :class do
  describe 'no params' do
    it { is_expected.to create_class('ipmi::service::ipmi') }
    it do
  ...
  describe 'with enable => not-a-bool' do
    ...
    it 'fails' do
      expect {
        is_expected.to contain_class('ipmi::service')
  ...
  describe 'with ensure => running' do
    ...
    it { is_expected.to create_class('ipmi::service::ipmi') }
    it do
      is_expected.to contain_service('ipmi').with(ensure: 'stopped',
                                                  hasstatus: true,
                                                  hasrestart: true,
                                                  enable: true)
    end
  ...
  describe 'with ensure => invalid-string' do
    ...
    it 'fails' do
      expect {
        is_expected.to contain_class('ipmi::service::ipmi')
